...
class metrics:
    ...
    def groundedness(self) -> Feedback:
        return  (
            Feedback(self._llm_provider.groundedness_measure_with_cot_reasons, name="groundedness")
    ...
    def context_relevance(self) -> Feedback:
        return (
        Feedback(self._llm_provider.qs_relevance_with_cot_reasons,
                 name="context_relevance")
        .on_input().on(self._context)
        .aggregate(np.mean)
    )
